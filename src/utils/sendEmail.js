...
const sendEmail = (res, user) => {
    ...
    mailOptions = {
        ...
        to: user.email,
        subject: "[Pega A Visão] Verificação de Email",
        text:`
            Olá!
            Boas vindas ao Pega a Visão!
            
            Você está quase pronto. Por favor confirme o seu email clicando no link abaixo. Não faremos spam
                                                                                    ...
                                                                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                                                                                        <tr>
                                                                                            <td align="center" style="font-size:0px;padding:8px 0 0 0;word-break:break-word;">
                                                                                                <div style="font-family:-apple-system, BlinkMacSystemFont, Helvetica, Arial, sans-serif;font-size:22px;font-weight:600;line-height:1.2;text-align:center;color:#000000;">Olá! Boas vindas ao Pega a Visão 👏</div>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </div>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td align="left" style="font-size:0px;padding:8px 0 16px 0;word-break:break-word;">
                                                                                                <div style="font-family:-apple-system, BlinkMacSystemFont, Helvetica, Arial, sans-serif;font-size:18px;font-weight:600;line-height:1.4;text-align:center;color:#8E8E92;">
                                                                                                    <span style="color: #000000;">Você está quase pronto.</span> Por favor confirme o seu email clicando no link abaixo. Não faremos spam ✌️
                                                                                                </div>
                                                                                                <div style="font-family:-apple-system, BlinkMacSystemFont, Helvetica, Arial, sans-serif;font-size:18px;font-weight:600;line-height:5;text-align:center;color:#8E8E92;">
                                                                                                    <a style="color: #4d4dff;text-decoration: none;" href="`+ link + `"> Clique Aqui</a>️
                                                                                                </div>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
