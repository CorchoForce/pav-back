...
const seedOffers = [
  ...
  },
  {
    ...
    description: "Venha aprender muito com ciência de dados e tudo que há em torno da área de Big Data.",
  ...
  },
  {
    ...
    type: "estagio",
    requirements: "Conhecimento em React.js, Node.js, Nomadismo Digital, Minoxidil 3%, IOT",
    site: "www.ufr.br",
    tags: ["estagio", "react"],
    description: "A Miceli Company está contratando estagiários na área de TI, não perca esta oportunidade. ",
    deadline: Date.parse("2021-05-30"),
    pay: "Voluntário",
    beginningDate: Date.now(),
  ...
  {
    title: "Curso Ficha Única de Notificação Compulsória de Maus-Tratos e Outras Violências",
    type: "extensao",
    requirements: "N/A",
    site: "N/A",
